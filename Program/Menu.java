...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        ListMhs.add(new Mahasiswa("2105879", "Farhan Muzhaffar Tiras Putra", "A", "Laki-laki"));
        ListMhs.add(new Mahasiswa("2105888", "Fatin Fauziyah Tiras Putri", "B", "Perempuan"));
        ListMhs.add(new Mahasiswa("2100879", "Muhammad Farhan", "C","Laki-laki"));
    ...
    public void insertData() {
        ...
        if(bLaki.isSelected()){
        gender = bLaki.getText();
        }else if(bPerempuan.isSelected()){
        gender = bPerempuan.getText();
        }
    ...
    int choice = JOptionPane.showConfirmDialog(null, "Apakah Anda Yakin Menghapus Data Mahasiswa Ini?", "Confirmation", JOptionPane.YES_NO_OPTION);
